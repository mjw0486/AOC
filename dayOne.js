...
const dayOne = function(array) {
  ...
  for (let num of array) {
    ...
    if (arrayMap.hasOwnProperty(num)) {
      return num * (target - num);
    }
  }
  return null;
}
// console.log(dayOne(array));

const dayOnePartTwo = function(array) {
  const arrayMap = {};
  const target = 2020;
  ...
  for (let i = 0; i < array.length; i ++) {
    if (arrayMap.hasOwnProperty(array[i]) && i !== arrayMap[array[i]][0] && i !== arrayMap[array[i]][1]) {
...
console.log(dayOnePartTwo(array));